...
class WPLMS_Admin_Welcome {
	...
	private $plugin;
	public $major_version = WPLMS_THEME_VERSION;
	/**
	...
	public function admin_css() {
		...
		wp_enqueue_style( 'vibe-activation', VIBE_URL.'/setup/installer/css/envato-setup.css',array(),WPLMS_VERSION);
	}
		...
		<div class="setup_wizard_wrapper">
			<div class="onboarding introduction">
				<div class="onboarding_header">
					<span><img id="wplms_logo" class="site-logo" src="<?php echo VIBE_URL.'/assets/images/logo.png';?>" alt="wplms">
						<span>The WordPress LMSspan>
					</span>
					
				</div>
				<div class="onboarding_introduction">
					<h2>Maintenance Update.</h2>
					<span><strong>5 Changes</strong>. 1 Enhancements . 2 Bug Fixes.</span>
				</div>
				<a href="https://wplms.io/support/article-categories/update-log/" target="_blank">
	...
	public function welcome_screen(){
		...
		<div class="welcome_slider">
		  	...
		  	<div class="slides">
		  		<div id="slide-1">
		  			<strong>Gutenberg Demo : Main <a href="https://demos.wplms.io/main" target="_blank">-></a></strong>
		  			<a href="https://demos.wplms.io/main" target="_blank"><img src="https://demos.wplms.io/wp-content/plugins/wplms-demos/main_demo.jpg" alt="wplms gutneberg app" /></a>
			    </div>
		  	</div>
	...
	public function support_screen(){
		...
		<div class="wplms_support_wrapper">
			<a href="https://wplms.ticksy.com" >Create a Support Topic</a>
		</div>
		<?php
	}
