...
class WPLMS_Init{
    ...
    function get_header(){
        ...
        if(isset($this->customizer['header_style']))
            return apply_filters('wplms_site_header_style',$this->customizer['header_style']);
        else
            return;
    }
    ...
    function get_footer(){
        ...
        if(isset($this->customizer['footer_style']))
            return apply_filters('wplms_site_footer_style',$this->customizer['footer_style']);
        else
            return;
    }
...
if(!function_exists('vibe_update_customizer')){
    function vibe_update_customizer($field,$value){
        ...
        if(empty($wplms->customizer)){
            $wplms->customizer = get_option('vibe_customizer');
        }
        if(!empty($wplms->customizer)){
...
function register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddypress.10.4.0.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '10.4.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/woocommerce.6.9.2.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/bbpress.2.6.6.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '2.6.6', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/elementor.3.10.1zip',
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
