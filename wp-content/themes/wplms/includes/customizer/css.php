...
$dom_array = array(
    ...
    'header_top_bg'  => array(
                            'element' => '#headertop,header.fixed,.pagesidebar,#pmpro_confirmation_table thead,header #searchdiv.active #searchform input[type=text],
                              div.pmpro_checkout h3,#pmpro_levels_table thead,.boxed #headertop .container,header.sleek.transparent.fixed',
    ...
    'header_color'  => array(
                            ...
                            header #searchicon,.mooc .topmenu>li>a, .mooc nav>.menu>li>a,#login_trigger,a.vibebp-login >a',
                            'css' => 'color'
                            ),
    ...
    'login_light'=> array(
                            'element' => '.logged-out #vibe_bp_login .fullscreen_login,#vibe_bp_login ul+ul,.login_popup',
                            'css' => 'background'
                            ),
    'login_light_color'=> array(
                            'element' => '#close_full_popup:before,#vibe_bp_login ul+ul li a,#vibe_bp_login ul+ul li a,.login_popup.medium .login_popup_content h2, .login_popup.elegance .login_popup_content h2,.login_popup.medium .login_popup_content, .login_popup.elegance .login_popup_content,.login_popup .loginform .input',
                            'css' => 'color'
                            ),
    'login_dark'=> array(
                              ...
                              #vibe_bp_login #wplms_custom_registration_form, #vibe_bp_login,.loginpopup_wrapper',
                              'css'     => 'background'
                            ),
  ...
  'body_container_width'=> array(
                            'element' => '.pusher .container',
                            'css' => 'max-width'
                      ),
  'content_bg'  => array(
  ...
  'content_color'  => array(
                            'element' => 'body,.content,#item-body,.widget.pricing,.dir-list,.item-list-tabs,
  ...
  'single_light_color'  => array(
                            ...
                            .elegant.single-course.c5 #item-nav, .single-course.c6 #item-nav,.single-course.c7 #item-nav,
...
foreach($dom_array as $style => $value){
    if(isset($theme_customizer[$style]) && $theme_customizer[$style] !=''){
        switch($value['css']){
            case 'font-size':
                echo vibe_sanitizer($value['element'].'{'.$value['css'].':'.$theme_customizer[$style].'px;}');
                break;
            case 'max-width':
                echo vibe_sanitizer($value['element'].'{'.$value['css'].':'.$theme_customizer[$style].'px;}');
                break;
            case 'background-image':
                echo vibe_sanitizer($value['element'].'{'.$value['css'].':url('.$theme_customizer[$style].');}');
                break;
             case 'margin':
             case 'padding':   
             case 'margin-top':
             ...
             case 'padding-bottom':
                ...
                break;
            case 'height':
            echo vibe_sanitizer($value['element'].'{'.$value['css'].':'.$theme_customizer[$style].'px;max-height:'.$theme_customizer[$style].'px;
                  }');
            case 'max-height':
                  echo vibe_sanitizer($value['element'].'{max-height:'.$theme_customizer[$style].'px;
                  }');  
            break;
            case 'font-family':
              $font = explode('-',$theme_customizer[$style]);

              echo vibe_sanitizer($value['element'].'{font-family:"'.$font[0].'";}'); 
            break;
            case 'padding-left-right':
                echo vibe_sanitizer($value['element'].'{
            ...
            case 'padding-top-bottom':
             ...
             case 'primary':
                echo '.button,input[type=button], input[type=submit],
                      ...
                      .vibe_carousel .flex-control-nav li a, .widget_carousel .flex-control-nav li a,.course8 .block_content .more a, .course8 .block_content .cat_btn,
                      .wplms_course_categories > *
                      {
                      ...
                      .block.generic .block_content .generic_category a:before,.block.generic .block_content .block_title a:before, .block.courseitem.course6 .block_media .postblock_cats .postblock_cat,.progress .bar,
                                          .block.courseitem.course6 .block_media .course_start_date,
                ...
                break;
                case 'custom_css':
                echo vibe_sanitizer($theme_customizer[$style]);
                break; 
                default:
                echo vibe_sanitizer($value['element'].'{'.$value['css'].':'.$theme_customizer[$style].';}');
                break;    
        }
      }
    }
        ...
        echo '.unit_content p span.side_comment:hover:after,.unit_content p span.side_comment.active:after{
          ...
          global $post;
          if(!empty($post) && !empty($post->post_type) && $post->post_type == 'learningpath'){
        ...
        if(isset($theme_customizer['nav_padding'])){
          ...
          header.sleek #vibe_bp_login,header.mooc #vibe_bp_login{
            top:'.(30+intval($theme_customizer['nav_padding'])).'px;
          }
        ...
        echo($buffer);
    echo 'body{--primary:'.$theme_customizer['primary_bg'].';}</style>';
}